...
export type ClaimStatus = 'pending' | 'processing' | 'uploaded' | 'failed' | 'moderation_rejected';
...
export class UploadClaim extends Document {
  ...
  @Prop({ required: true, enum: ['pending', 'processing', 'uploaded', 'failed', 'moderation_rejected'] })
  status: ClaimStatus;
